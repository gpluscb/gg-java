...
public class Checks {
	...
	public static void nonNull(Object object, String name) throws IllegalArgumentException {
		if(object == null) throw new IllegalArgumentException("Parameter " + name + " is null");
	}
	...
	public static void notEmpty(@Nonnull String string, String name) {
		...
		if(string.isEmpty()) throw new IllegalArgumentException("Parameter " + name + " is empty");
	}
	
	/**
	 * @throws IllegalArgumentException if collection contains null values (or is null)
	 */
	public static void noneNull(@Nonnull Collection<? extends Object> collection, String name) throws IllegalArgumentException {
		nonNull(collection, "collection");
		if(collection.contains(null)) throw new IllegalArgumentException("Parameter " + name + " contains null values");
	}
	...
	public static void nonNegative(@Nonnull Number number, String name) throws IllegalArgumentException {
		...
		if(number.doubleValue() < 0) throw new IllegalArgumentException("Parameter " + name + " is negative");
	}
}
